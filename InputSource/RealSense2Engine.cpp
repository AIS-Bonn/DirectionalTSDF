...
: BaseImageSourceEngine(calibFilename)
{
	...
	this->calib.intrinsics_d.SetFrom(this->imageSize_d.x, this->imageSize_d.y, intrinsics_depth.fx, intrinsics_depth.fy,
	                                 intrinsics_depth.ppx, intrinsics_depth.ppy);
	this->calib.intrinsics_rgb.SetFrom(this->imageSize_rgb.x, this->imageSize_rgb.y, intrinsics_rgb.fx, intrinsics_rgb.fy,
